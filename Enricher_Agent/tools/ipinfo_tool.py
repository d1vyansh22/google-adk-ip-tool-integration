...
This tool integrates with IPInfo API to gather geolocation and network information 
about IP addresses as a Google ADK FunctionTool.
"""
...
def check_ipinfo_tool(ip_address: str) -> Dict[str, Any]:
    """
    Google ADK Function Tool wrapper for IPInfo API.
    
    This function is designed to be used as a Google ADK Function Tool.
    It provides geolocation and network information for IP addresses.
